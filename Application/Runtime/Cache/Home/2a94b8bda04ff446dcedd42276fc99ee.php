...
<div id="sub-header" class="subhead hidden-tablet hidden-phone " data-stellar-vertical-offset="100" data-stellar-background-ratio="0.5" style="background: url('/git/Public/images/p2p4.jpg') 10% 0px no-repeat transparent;">
    <div class="container">
        <h1 class="para-title" style="color:white;margin-bottom:50px;margin-top:30px;">P2P互联网金融栏目之家</h1>
        <p class="para-quote"></p>
    </div>
</div>
<!-- 左右按键 -->
...
<div class="container">
	<div class="col-md-12">
		<h4>公司项目</h4>
		<div class="row event-row" style="padding-left:15px;padding-right:15px;">
			<div  class="event col-md-6 gradeschool" style="border-width:10px 0 0;border-style:solid;padding:4rem 0;text-align:center;background:#ffffff">
				<h5 class="data">
					<span></span>
				</h5>				
					<h5 class='data'>
						<span><img src="/git/Public/images/lanmu.jpg" style="width:198px;height:178px" class=""></span>
					</h5>
					<hr/>									
				<h5>互联网金融电视栏目</h5>
				<hr/>
				<a href="#"><span class="view" style="display:inline-block;padding:.5rem 3.5rem;color:#969696;text-transform:uppercase;border:2px solid #969696">查看查看</span><div class="classicon"></div>
				</a>
				
			</div>
			

			<div class="event col-md-6 gradeschool" style=" border-color:#fed666;border-width:10px 0 0;border-style:solid;padding:4rem 0;text-align:center;background:#eaeaea">
				<h5 class="data">
					<span></span>
				</h5>
					<h5 class='data'>
						<span><img src="/git/Public/images/wjb.jpg" style="width:198px;height:178px" class=""></span>
					</h5>
					<hr/>
				<h5>
					<span>网金榜P2P门户网站</span>
				</h5>
				<hr/>
				<a href="#"><span class="view" style="display:inline-block;padding:.5rem 3.5rem;color:#969696;text-transform:uppercase;border:2px solid #969696">查看查看</span><div class="classicon"></div>
				</a>				
